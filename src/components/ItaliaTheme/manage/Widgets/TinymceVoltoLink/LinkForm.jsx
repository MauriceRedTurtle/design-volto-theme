...
class LinkForm extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      value: isInternalURL(props.url)
        ? flattenToAppURL(props.url)
        : props.url || '',
      isInvalid: false,
    };
  ...
  onSelectItem = (e, url) => {
    ...
    this.props.setLink(addAppURL(url));
  };
...
export default compose(injectIntl, withRouter, withObjectBrowser)(LinkForm);
